...
| Contract | Id |
| --- | --- |
| `attest` | `CC3PQUJKHPRSIHIH53GNIC6DIDOIJWCCGQ7NYZROBAS6TZLUGLOM5XQC` |
| `record` | `CCQCHPJGDR4VYJQEGCSNO3XQDQ2VT4GARVT4CV25K4AEKCFMATRFGAFF` |
| `registry` | `CCBQHBNIG5FIJEM6SQZQGTQRO3XXHV2BGVGGUY5JXXZ3Y55ZJSV3HMVF` |
| `policy_spend` | `CD2F5HMCPZCPXFHEFRNVNCQFYKYZZND4EIV3BQXK2NP7PYFY57OZIYTS` |

Programmes are instantiated from wasm hash
`e67285c05f575e7490bf33c424781d6279a35040d46f02694ddc9766b7bed6e7`, so each gets
